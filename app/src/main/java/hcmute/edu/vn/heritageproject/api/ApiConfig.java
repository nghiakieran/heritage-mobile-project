...
public class ApiConfig {    // URL API - Cập nhật theo API thực tế
    ...
    private static final String EMULATOR_BASE_URL = "http://192.168.123.22:8017/v1/"; // 10.0.2.2 trỏ đến localhost máy host từ emulator
    private static final String DEVICE_DEBUG_URL = "http://192.168.123.22:8017/v1/"; // URL cho thiết bị thật trong mạng LAN
